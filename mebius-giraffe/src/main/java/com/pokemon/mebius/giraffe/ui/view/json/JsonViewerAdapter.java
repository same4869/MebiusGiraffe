package com.pokemon.mebius.giraffe.ui.view.json;
...
//            throw new IllegalArgumentException("jsonStr is illegal.");
    ...
    class RawItemClickListener implements View.OnClickListener {

        private CharSequence value;
        private JsonItemView itemView;

        RawItemClickListener(CharSequence value, JsonItemView itemView) {
            this.value = value;
            this.itemView = itemView;
        }
