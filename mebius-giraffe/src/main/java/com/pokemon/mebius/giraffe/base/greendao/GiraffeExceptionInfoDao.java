...
/** 
 * DAO for table "GIRAFFE_EXCEPTION_INFO".
*/
public class GiraffeExceptionInfoDao extends AbstractDao<GiraffeExceptionInfo, Long> {

    public static final String TABLENAME = "GIRAFFE_EXCEPTION_INFO";

    /**
     * Properties of entity GiraffeExceptionInfo.<br/>
    ...
    public GiraffeExceptionInfoDao(DaoConfig config) {
        super(config);
    }
    
    public GiraffeExceptionInfoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GIRAFFE_EXCEPTION_INFO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"GIRAFFE_EXCEPTION_INFO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, GiraffeExceptionInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, GiraffeExceptionInfo entity) {
        stmt.clearBindings();
    ...
    @Override
    public GiraffeExceptionInfo readEntity(Cursor cursor, int offset) {
        GiraffeExceptionInfo entity = new GiraffeExceptionInfo( //
    ...
    @Override
    public void readEntity(Cursor cursor, GiraffeExceptionInfo entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(GiraffeExceptionInfo entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(GiraffeExceptionInfo entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(GiraffeExceptionInfo entity) {
